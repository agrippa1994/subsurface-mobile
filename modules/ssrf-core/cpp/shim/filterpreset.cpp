// AI-generated (Claude)
//
// Replaces core/filterpreset.cpp, which is Qt-free apart from the QString
// round trip in set_fulltext()/fulltext_query(). With the Qt-free FullTextQuery
// from cpp/shim/override/fulltext.h those become plain std::string moves.

#include "filterpreset.h"

std::string filter_preset::fulltext_query() const
{
	return data.fullText.originalQuery;
}
